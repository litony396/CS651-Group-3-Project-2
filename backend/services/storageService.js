...
// function that uploads audio to Firebase bucket
const uploadAudio = async (audioData, audioName, username, fileType) => {
    try {
        ...
        // this fileName is where the audio is stored on the cloud storage
        ...
        const safeName = audioName.replace(/[^a-zA-Z0-9.]/g, '_')
        const fileName = `audio/${username}_${timestamp}_${safeName}`;
        ...
        throw new Error("Audio Upload to Firebase Bucket Failed.")
    }
}
