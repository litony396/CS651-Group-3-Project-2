...
const generateDiagnosis = async (imageURLs, audioUrl, plantHistory) => {
    try {
        ...
        // convert schema to be readable by Gemini
        // get rid of .$schema because it is generated by Zod and Gemini throws errors when it is seen for some reason
        const geminiSchema = zodToJsonSchema(diagnosisSchema)
